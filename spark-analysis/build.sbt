...
libraryDependencies += "org.apache.spark" % "spark-sql-kafka-0-10_2.12" % "2.4.5" % "provided"
libraryDependencies += "org.apache.spark" % "spark-streaming-kafka-0-10_2.12" % "2.4.5" % "provided"
