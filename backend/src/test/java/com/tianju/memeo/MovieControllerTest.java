...
public class MovieControllerTest {
    ...
    public void visitApiWithoutToken() {
        ResponseEntity<Response> resp =
                testRestTemplate.exchange("/movie/testuser", HttpMethod.GET, null, Response.class);
    ...
    public void visitApiWithInvalidToken() {
        ...
        ResponseEntity<Response> resp =
                testRestTemplate.exchange("/movie/testuser", HttpMethod.GET, new HttpEntity<>(null, httpHeaders), Response.class);
        Assert.assertEquals(HttpStatus.UNAUTHORIZED, resp.getStatusCode());
    }
